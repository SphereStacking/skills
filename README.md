...
/plugin install research@sphere-skills
```
...
### [research](./plugins/research)

複数観点リサーチオーケストレーター。

- 3つの調査エージェント（肯定的・批判的・実践的）を並列起動して多角的に調査
- 結果をマージ後、統合レビューエージェントが矛盾・偏り・欠落を検出
- バランスの取れた最終レポートを生成

**使い方:**

```
「〜について調べて」「〜を多角的にリサーチ」などで自動発動
```
